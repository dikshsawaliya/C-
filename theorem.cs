    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                // comments as needed
                Console.Write("Enter 1x: ");
                float point1X = float.Parse(Console.ReadLine());
                
                Console.Write("Enter point1Y: ");
                float point1Y = float.Parse(Console.ReadLine());
                
                Console.Write("Enter point2X: ");
                float point2X = float.Parse(Console.ReadLine());
                
                Console.Write("Enter point2Y: ");
                ...
                Console.WriteLine("The angle between the points is: {0}", distance);
